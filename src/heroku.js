...
module.exports = [
  {
    ...
    react: "➕" // Represents adding a new variable
  },
  {
    command: ["delvar"],
  ...
  },
  {
    ...
    react: "🔍" // Indicates searching or retrieving
  },
  {
    command: ["setbotname"],
  ...
  },
  {
    ...
    react: "📞" // Symbolizes a phone number
  },
  {
    command: ["setvar"],
    operate: async (context) => {
    ...
    react: "⚙️" // Indicates configuration or settings
  },
];